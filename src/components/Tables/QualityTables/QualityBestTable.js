...
import { selectMonths } from '../../../actions/quality_best_table_months';

const mapStateToProps = (state) => {
  return {
    suppliers: state.suppliers.suppliers,
    isPending: state.suppliers.isPending,
    displayedMonths: state.quality_best_table_months.months,
...
class QualityBestTable extends React.Component {
        ...
        <Widget>
          <div className={s.root}>
              <div style={{display: "flex", justifyContent: 'space-between', alignItems: "center"}}>
                  <h3 className="page-title"><span className="fw-semi-bold">Items with Least Quality Issues <p style={{ fontWeight:'normal'}}>(Top 3)</p></span></h3>
...
export default connect(mapStateToProps, mapDispatchToProps)(QualityBestTable);