...
import { selectItem } from '../../../actions/change_item_for_otd_pie_chart';
import { displayItem } from '../../../actions/selected_otd_pie_chart_item';

const mapStateToProps = (state) => {
  return {
    items: state.items.items,
    isPending: state.items.isPending,
    isItemSelected: state.change_item_for_otd_pie_chart.isItemSelected,
