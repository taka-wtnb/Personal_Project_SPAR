...
import s from './QualityManagementPieChart.module.scss';

import Widget from '../../Widget/Widget';

import { selectMonths } from '../../../actions/quality_management_pie_chart_months';

import ItemSelection from './ItemSelectionForQualityManagementPieChart';
...
const mapStateToProps = (state) => {
  return {
    ...
    displayedMonths: state.quality_management_pie_chart_months.months,
    selectedSupplier: state.selected_supplier.selectedSupplier,
    items: state.items.items,
    isItemPending: state.items.isPending,
    selectedItem: state.selected_quality_management_pie_chart_item.selectedItem,
  }
}
...
class QualityManagementPieChart extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(QualityManagementPieChart);