...
import { selectItem } from '../../../actions/change_item_for_dashboard_spending_chart';
import { displayItem } from '../../../actions/selected_dashboard_spending_chart_item';

const mapStateToProps = (state) => {
  return {
    items: state.items.items,
    isPending: state.items.isPending,
    isItemSelected: state.change_item_for_dashboard_spending_chart.isItemSelected,
