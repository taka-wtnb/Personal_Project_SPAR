        ...
        <Widget>
          <div className={s.root}>
              <div style={{display: "flex", justifyContent: 'space-between', alignItems: "center"}}>
                  <h3 className="page-title"><span className="fw-semi-bold"><span style={{ color:'#F45722' }}>Most</span> Ordered Items (Top 3)</span></h3>
                ...
                <Table>
                  <thead>
                    <tr>
                      ...
                      <th style={{ color:'#F45722',textAlign: 'center'}}>Amount <br /> ($)</th>
                    </tr>
                  </thead>
                  <tbody>
