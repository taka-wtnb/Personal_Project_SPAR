...
import { selectItem } from '../../../actions/change_item_for_quality_management_pie_chart';
import { displayItem } from '../../../actions/selected_quality_management_pie_chart_item';

const mapStateToProps = (state) => {
  return {
    items: state.items.items,
    isPending: state.items.isPending,
    isItemSelected: state.change_item_for_quality_management_pie_chart.isItemSelected,
