...
[View the App](https://spar-web-app.herokuapp.com/) (When you are on the Login page, simply click the 'Login' button to login.)_
***(Note: It may take 10 – 20 secs to load the initial page due to the platform (Heroku)'s account setting.)***
