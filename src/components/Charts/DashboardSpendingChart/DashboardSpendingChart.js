...
import s from './DashboardSpendingChart.module.scss';

import Widget from '../../Widget/Widget';

import { selectMonths } from '../../../actions/dashboard_spending_chart_months';

import ItemSelection from './ItemSelectionForDashboardSpendingChart';
...
const mapStateToProps = (state) => {
  return {
    ...
    displayedMonths: state.dashboard_spending_chart_months.months,
    selectedSupplier: state.selected_supplier.selectedSupplier,
    items: state.items.items,
    isItemPending: state.items.isPending,
    selectedItem: state.selected_dashboard_spending_chart_item.selectedItem,
  }
}
...
class DashboardSpendingChart extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(DashboardSpendingChart);